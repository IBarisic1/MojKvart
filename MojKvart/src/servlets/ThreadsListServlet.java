...
@WebServlet("/threadslist")
public class ThreadsListServlet extends HttpServlet {
	private static final long serialVersionUID = -8549027119580329913L;

	public ThreadsListServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			threads = ForumThreadDAO.queryThread(conn, neighborhood);
		...
		RequestDispatcher dispatcher = request.getServletContext()
				.getRequestDispatcher("/WEB-INF/views/threadsListView.jsp");
